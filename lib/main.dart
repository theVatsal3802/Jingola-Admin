...
import './screens/voucher_display_screen.dart';
import './screens/edit_menu_screen.dart';
import './screens/delivery_boy_display_screen.dart';
import './screens/past_order_screen.dart';
import './screens/add_voucher_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        ManagerDisplayScreen.routeName: (context) =>
            const ManagerDisplayScreen(),
        AddStaffScreen.routeName: (context) => const AddStaffScreen(),
        ChefDisplayScreen.routeName: (context) => const ChefDisplayScreen(),
        DeliveryBoyDisplayScreen.routeName: (context) =>
            const DeliveryBoyDisplayScreen(),
        VoucherDisplayScreen.routeName: (context) =>
            const VoucherDisplayScreen(),
        AddVoucherScreen.routeName: (context) => const AddVoucherScreen(
              data: {},
              id: "",
            ),
